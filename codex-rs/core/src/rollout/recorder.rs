...
///
/// ```ignore
/// $ jq -C . ~/.codeACE/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.codeACE/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn create_log_file(
    ...
    // Resolve ~/.codeACE/sessions/YYYY/MM/DD and create it if missing.
