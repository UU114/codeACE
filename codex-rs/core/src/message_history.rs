...
//!
//! The history is stored at `~/.codeACE/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.codeACE`.
...
pub(crate) async fn append_entry(
    ...
    // Resolve `~/.codeACE/history.jsonl` and ensure the parent directory exists.
